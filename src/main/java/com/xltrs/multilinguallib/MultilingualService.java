package com.xltrs.multilinguallib; //Version 20260924
...
public class MultilingualService {
    ...
    public static void Register(String client) {
        ...
        try (ZipFile ClientJar = new ZipFile(ModList.get().getModFileById(client).getFile().getFilePath().toFile())) {
            ...
            ShowDebugInfo("[MultilingualLib] Register %s mod multilingual service failed in IOException", client);
            e.printStackTrace();
        }
    }
    ...
    private static void ShowDebugInfo(String ShowInfo, Object... args) {
